...
class SinglyLinkedList {
    ...
    /*
    create a function that takes in a singly linked list
    iterate through the linked the list to find the end
        where the next value is undefined
    set the next variable equal to the data that was passed in
    return head
    */
...
// console.log(singleNodeList.insertAtBack(2));
