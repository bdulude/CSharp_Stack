...
class BinarySearchTree {
    ...
    /*
    Pseudocode:
    create a method that returns a bool after searching for a given argument value
    check if the tree is empty, return false if so
    create runner to run towards the search value
    while runner.left !== null && runner.right !== null || 
        two ifs to move the runner
            if runner.data === searchVal return true
            one if for moving to the left (data < runner.data)
            one if for moving to the right (data > runner.data)
    return false
    */
    contains(searchVal) {
        if (this.isEmpty()){
     ...
     */
    /*
    create a method to return the range of the node
    ...
    */
    range(startNode = this.root) {
        ...
        return this.maxRecursive() - this.minRecursive()
    }
