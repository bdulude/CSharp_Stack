...
class SinglyLinkedList {
     ...
     */
    /*
    create a function that takes in a data
    make a variable called neck, set the head to it
    make the new head with the data calling Node
    head.next = neck
    return this
    */
    ...
    /*
    create a function
    create a temp variable to store removed data
    ...
    */
     ...
     */
    /*
    create a function that returns an average of the data or NaN
    create a counter variable to count nodes
    create a total variable to total data
    create a runner to iterate through the list
    use a while loop to iterate through the list
        update counter and total
        if data is not a number, return NaN
    return total / counter
    */


    average() {
        if (this.head == null) return NaN
        let counter = 0
        let total = 0
        let runner = this.head
        while (runner != null) {
            if (isNaN(runner.data)) return NaN
            counter++
            total += runner.data
            runner = runner.next
        }
