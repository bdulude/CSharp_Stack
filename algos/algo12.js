...
class BinarySearchTree {
    ...
    /*
        creating a function that takes in a new value
        create a new node with the value
        if root is null, set new node to root
        create a runner
        create a chaser
        create a boolean called right to indicate left or right insertion
        create a while loop where runner is not equal to null
            if the new value is greater than the runner.data
                set chaser to runner
                set runner to runner.right
                right = true
            if the new value is less than or equal to the runner.data
                set chaser to runner
                set runner to runner.left
                right = false
        if right
            chaser.right = new node
        else
            chaser.left = new node
        return this
    */
    insert(newVal) { 
        ...
        if (right) chaser.right = newNode;
        else chaser.left = newNode;
        return this;
    }
